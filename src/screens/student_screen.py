...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name" , placeholder="Abhinav Patel")
            ...
            try:
                audio_data = st.audio_input("Record a short phrase like I am present , My name is Abhinav")
            except Exception:
                    ...
                    with st.spinner("Creating Profile...."):
                        ...
                        if encodings:
                            ...
                            if response_data:
                                ...
                                st.toast(f"Profile Created! Hi {response_data[0]["name"]}!")
                                time.sleep(1)
                                st.rerun()
                            else:
