...
def teacher_dashboard():
    ...
    with c2:
        ...
        if st.button("Logout" , type="secondary" , key="teacher_login_back_btn"):
...
def teacher_tab_take_attendance():
    ...
    if not subjects:
        st.warning("You haven't created any subjects yet. Please create first!")
        return
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter your username" , placeholder="Abhinav Patel" )
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter your username" , placeholder="Abhinav Patel" )
    teacher_name = st.text_input("Enter your name" , placeholder="Abhinav Patel" )
